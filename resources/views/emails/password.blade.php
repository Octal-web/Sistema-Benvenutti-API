...
<head>
    ...
    <title>Alteração de senha | Todeschini</title>
                ...
                <tr>
                    <td align="center"  bgcolor="#1D1D1D" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:32px;line-height:52px;font-weight:700;font-style:normal;color:#D1B97B;text-decoration:none;letter-spacing:0px;">

                                    <div>
                                        Você solicitou uma troca de senha!
                                    </div>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="https://wa.me/5421028100" style="color:#6e6e6e;"><span>(54) 2102 8100</span></a>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:eduarda.schimitz@tdsfranquias.com.br" style="color:#6e6e6e;"><span>eduarda.schimitz@tdsfranquias.com.br</span></a>
