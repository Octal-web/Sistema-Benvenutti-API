...
<head>
    ...
    <title>Obrigado pelo seu contato! | Todeschini</title>
...
<table border="0" align="center" cellpadding="0" cellspacing="0" width="100%" style="width:100%;max-width:100%;">
    <tr><!-- Outer Table -->
        <td align="center"  bgcolor="#1D1D1D" data-composer>

            <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                <!-- lotus-header-4 -->
                <tr>
                    <td align="center"  bgcolor="#1D1D1D" class="container-padding">
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                                    ...
                                    <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" width="100%" style="width:100%;max-width:100%;">
                                        <tr>
                                            <td align="center" class="container-padding">
                                                <a href="{{ env('SITE_URL') }}"><img style="width:180px;border:0px;display: inline!important;" src="{{ env('SITE_URL') }}/assets/img/logo.png" width="180" border="0" alt="Todeschini"></a>
                                            </td>
                                        </tr>
                                    </table>
                                    <!-- Logo & Webview -->
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Roboto',Arial,Helvetica,sans-serif;font-size:30px;line-height:32px;font-weight:700;font-style:normal;color:#D1B97B;text-decoration:none;letter-spacing:0px;">

                                    <div>
                                        Você foi convidado para a viagem da Benvenutti!
                                    </div>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div>
                                        Seja bem-vindo(a)! Contamos com a sua presença nessa viagem inesquecível.
                                    </div>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:16px;line-height:26px;font-weight:300;font-style:normal;color:#FFFFFF;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <div style="color: #fff">
                                        Para completar o seu cadstro, use o link abaixo:
                                    </div>
                                    <a style="text-decoration: underline; color: #fff" href="{{ env('SITE_URL') }}/cadastro/finalizar/{{ $token }}">{{ env('SITE_URL') }}/cadastro/finalizar/{{ $token }}</a>
                                </td>
                            </tr>
                            <tr>
                                <td height="30" style="font-size:30px;line-height:30px;">&nbsp;</td>
                        ...
                        <table border="0" align="center" cellpadding="0" cellspacing="0" role="presentation" class="row" width="580" style="width:580px;max-width:580px;">
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="https://wa.me/5499999999" style="color:#6e6e6e;"><span>(54) 9999-9999</span></a>
                            ...
                            <tr>
                                <td class="center-text" align="center" style="font-family:'Poppins',Arial,Helvetica,sans-serif;font-size:14px;line-height:24px;font-weight:400;font-style:normal;color:#6e6e6e;text-decoration:none;letter-spacing:0px;">
                                    ...
                                    <a href="mailto:email@gmail.com" style="color:#6e6e6e;"><span>email@gmail.com</span></a>
